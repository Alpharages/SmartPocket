...
This project is indexed by GitNexus as **SmartPocket** (4639 symbols, 10766 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

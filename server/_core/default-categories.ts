...
export const DEFAULT_CATEGORIES: readonly DefaultCategoryDef[] = [
  {
    name: "Groceries",
    type: "expense",
    color: getCategoryColorForName("Groceries"),
    icon: "cart",
  },
  {
    name: "Dining",
    type: "expense",
    color: getCategoryColorForName("Dining"),
    icon: "restaurant",
  },
  {
    name: "Transport",
    type: "expense",
    color: getCategoryColorForName("Transport"),
    icon: "car",
  },
  {
    name: "Housing",
    type: "expense",
    color: getCategoryColorForName("Housing"),
    icon: "home",
  },
  {
    name: "Utilities",
    type: "expense",
    color: getCategoryColorForName("Utilities"),
    icon: "flash",
  },
  {
    name: "Shopping",
    type: "expense",
    color: getCategoryColorForName("Shopping"),
    icon: "bag",
  },
  {
    name: "Health",
    type: "expense",
    color: getCategoryColorForName("Health"),
    icon: "medkit",
  },
  {
    name: "Entertainment",
  ...
  },
  {
    name: "Salary",
    type: "income",
    color: getCategoryColorForName("Salary"),
    icon: "cash",
  },
  {
    name: "Other Income",
